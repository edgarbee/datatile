...
@include("includes.header")
        <div class="main-section">
            ...
            <div class="clients_slider">
                <div class="slider">
                <div class="slide">
                    <img loading="lazy" src="{{ asset('assets/img/RAM_logo_small.jpg') }}">
                    <img loading="lazy" src="{{ asset('assets/img/sinomonitor_small.png') }}">
                    <img loading="lazy" src="{{ asset('assets/img/Mediametrie%20logo.png') }}">
                    <img loading="lazy" src="{{ asset('assets/img/omd.svg') }}">
                    <img loading="lazy" src="{{ asset('assets/img/kantar.svg') }}">
                    <img loading="lazy" src="{{ asset('assets/img/ipsos.svg') }}">
                    <img loading="lazy" src="{{ asset('assets/img/global.svg') }}">
                    <img loading="lazy" src="{{ asset('assets/img/gfk.svg') }}">
                </div>
                <div class="slide">
                    <img loading="lazy" src="{{ asset('assets/img/RAM_logo_small.jpg') }}">
                    <img loading="lazy" src="{{ asset('assets/img/sinomonitor_small.png') }}">
            ...
            <div class="human">
                <img loading="lazy" class="pc-human" src="{{ asset('assets/img/human.png') }}" alt="">
                <img loading="lazy" class="mob-human" src="{{ asset('assets/img/human1.png') }}" alt="">
            </div>

            <div class="restangle">
                <img loading="lazy" src="{{ asset('assets/img/restangle.png') }}" alt="">
            </div>
        </div>
            ...
            <div class="slider-container slider-mob">
                <div class="swiper mySwipermob">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><img loading="lazy" src="{{ asset('assets/img/diagramm3.png') }}" alt=""></div>
                        <div class="swiper-slide"><img loading="lazy" src="{{ asset('assets/img/diagramm2.png') }}" alt=""></div>
                        <div class="swiper-slide"><img loading="lazy" src="{{ asset('assets/img/diagramm1.png') }}" alt=""></div>
                        <div class="swiper-slide"><img loading="lazy" src="{{ asset('assets/img/diagramm4.png') }}" alt=""></div>
                        <div class="swiper-slide"><img loading="lazy" src="{{ asset('assets/img/diagramm5.png') }}" alt=""></div>
                    </div>
                </div>
                ...
                <div class="ceo-quote">
                    ...
                    <div class="ceo-images-container">
                        <div class="ceo-images">
                            <img loading="lazy" src="{{ asset('assets/img/ceo.png') }}" alt="">
                        </div>
                        <div class="ceo-name">
                            Alex Chilingarian
    ...
    <div class="fiolet-bg">
        <div class="container sliderswiper">
            ...
            <div class="video-container">
                <div class="video">
                    <img loading="lazy" src="{{ asset('assets/img/video.png') }}" alt="">
                </div>
            ...
            <div class="reviews-container">
                <div class="reviews-item">
                    <div class="star">
                        <img loading="lazy" src="{{ asset('assets/img/star.svg') }}" alt="">
                    </div>
        ...
        <div class="d">
            <img loading="lazy" src="{{ asset('assets/img/d.svg') }}" alt="">
        </div>
    </div>
    ...
    <div class="schema-container">
        <div class="big-container order-1">
            <div class="schema-img">
                <img loading="lazy" class="d-xs-none" src="{{ asset('assets/img/schema1.png') }}" alt="">
                <img loading="lazy" class="d-xs-block" src="{{ asset('assets/img/schema-mob-1.png') }}" alt="">
            </div>
        </div>
        ...
        <div class="small-container small-container-1 order-3">
            <div class="schema-img">
                <img loading="lazy" class="d-xs-none" src="{{ asset('assets/img/schema2.png') }}" alt="">
                <img loading="lazy" class="d-xs-block" src="{{ asset('assets/img/schema-mob-2.png') }}" alt="">
            </div>
        </div>

        <div class="big-container order-5">
            <div class="schema-img">
                <img loading="lazy" class="d-xs-none" src="{{ asset('assets/img/schema3.png') }}" alt="">
                <img loading="lazy" class="d-xs-block" src="{{ asset('assets/img/schema-mob-3.png') }}" alt="">
            </div>
        </div>
        ...
        <div class="small-container small-container-2 order-7">
            <div class="schema-img">
                <img loading="lazy" class="d-xs-none" src="{{ asset('assets/img/schema4.png') }}" alt="">
                <img loading="lazy" class="d-xs-block" src="{{ asset('assets/img/schema-mob-4.png') }}" alt="">
            </div>
        </div>

        <div class="awards order-9">
            <div class="awards-item">
                <img loading="lazy" src="{{ asset('assets/img/award1.png') }}" alt="">
            </div>
            <div class="awards-item">
                <img loading="lazy" src="{{ asset('assets/img/award2.png') }}" alt="">
            </div>
        </div>
    </div>

    @include("includes.clients", ['bg'=>''])
