<header>
    <div class="header">
        <div class="container sup-container">
            ...
            <div class="sup-menu">
                <?php $__currentLoopData = Menu::getByName('Login'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $login): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="login <?php echo e($login['class']); ?>">
                    <div class="button">
                        <a class="btn btn-login" href="<?php echo e($login['link']); ?>">
                          <span><?php echo e($login['label']); ?></span>
                        </a>
                    </div>
                </div>
...
</div><?php /**PATH C:\OpenServer\domains\datatile\resources\views/includes/header.blade.php ENDPATH**/ ?>