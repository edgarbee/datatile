...
<div class="card m-4">
    <div class="card-body">
        <h5 class="card-title"><?php echo e(strip_tags($solution->title)); ?></h5>
        <p>Style color: <?php echo e($solution->color); ?></p>
...
<?php echo $__env->make("binshopsblog_admin::layouts.admin_layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\datatile\vendor\binshops\laravel-blog\src/Views/binshopsblog_admin/solutions/main.blade.php ENDPATH**/ ?>