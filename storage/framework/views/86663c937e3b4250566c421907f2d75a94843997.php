...
<form action="<?php echo e(route('binshopsblog.admin.page.update', ['pages_id' => $page->id])); ?>" enctype="multipart/form-data" method="post">
    ...
    <div class="form-group">
        ...
        <small id="category_category_name_help" class="form-text text-muted">Use only &lt;br class="d-xs-block"&gt; and  &lt;span class="blue"&gt;&lt;/span&gt; or &lt;span class="red"&gt;&lt;/span&gt; or &lt;span class="fiolet"&gt;&lt;/span&gt; or &lt;span class="yellow"&gt;&lt;/span&gt; </small>
...
<?php echo $__env->make("binshopsblog_admin::layouts.admin_layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/c/cq12260/test/public_html/vendor/binshops/laravel-blog/src/Views/binshopsblog_admin/page/edit.blade.php ENDPATH**/ ?>