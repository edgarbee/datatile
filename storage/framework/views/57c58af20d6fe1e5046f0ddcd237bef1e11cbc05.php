...
<?php $__env->startSection('title', 'DataTile About'); ?>
...
<div class="about-us">
    <div class="line">
        <img loading="lazy" class="pc-human" src="<?php echo e(asset('assets/img/line.png')); ?>" alt="">
        <img loading="lazy" class="mob-human" src="<?php echo e(asset('assets/img/line1.png')); ?>" alt="">
    </div>
    <div class="container">
...
<div class="list-founder">
    <div class="restangle-founder">
        <img loading="lazy" src="<?php echo e(asset('assets/img/restangle-5.png')); ?>" alt="">
    </div>
    <div class="container">
        <div class="list-founder-row">
            <div class="list-founder-container">
                <div class="list-founder-item">
                    <div class="list-founder-image">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/founder-1.png')); ?>" alt="">
                    </div>
            ...
            <div class="list-founder-container">
                <div class="list-founder-item">
                    <div class="list-founder-image">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/founder-2.png')); ?>" alt="">
                    </div>
                    <div class="list-founder-text">
            ...
            <div class="list-founder-container">
                <div class="list-founder-item">
                    <div class="list-founder-image">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/founder-3.png')); ?>" alt="">
                    </div>
                    <div class="list-founder-text">
            ...
            <div class="list-founder-container">
                <div class="list-founder-item">
                    <div class="list-founder-image">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/founder-4.png')); ?>" alt="">
                    </div>
                    <div class="list-founder-text">
        ...
        <div class="partners-clients">
            <div class="our-partners">
                ...
                <div class="our-partners-item">
                    <img loading="lazy" src="<?php echo e(asset('assets/img/logo-tiburon.png')); ?>" alt="">
                </div>
                <div class="our-partners-item">
                    <img loading="lazy" src="<?php echo e(asset('assets/img/logo-fastuna.png')); ?>" alt="">
                </div>
                <div class="our-partners-item mb-0">
                    <img loading="lazy" src="<?php echo e(asset('assets/img/logo-ctr.png')); ?>" alt="">
                </div>
            </div>
            <div class="our-clients">
                ...
                <div class="row-clients d-xs-none">
                    <div class="our-clients-item">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/logo-kantar.png')); ?>" alt="">
                    </div>
                    <div class="our-clients-item">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/logo-ipsos.png')); ?>" alt="">
                    </div>
                    <div class="our-clients-item">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/logo-omd.png')); ?>" alt="">
                    </div>
                </div>

                <div class="row-clients d-xs-none">
                    <div class="our-clients-item">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/logo-reppublika.png')); ?>" alt="">
                    </div>
                    <div class="our-clients-item">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/logo-gfk.png')); ?>" alt="">
                    </div>
                    <div class="our-clients-item">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/logo-estee-lauder.png')); ?>" alt="">
                    </div>
                </div>
            ...
            <div class="container">
                <div class="reach">
                    <div class="reach-item">
                        <img loading="lazy" class="reach-img" src="<?php echo e(asset('assets/img/map1.png')); ?>" alt="">
                        <h3 class="yellow">EMEA</h3>
                        <div class="reach-text">
                            <img loading="lazy" src="<?php echo e(asset('assets/img/icon1.svg')); ?>" alt="">
                            <b>Alex Maddox</b>
                        </div>

                        <div class="reach-text">
                            <img loading="lazy" src="<?php echo e(asset('assets/img/icon2.svg')); ?>" alt="">
                            <a href="mailto:emea@datatile.eu">emea@datatile.eu</a>
                        </div>

                        <div class="reach-text">
                            <img loading="lazy" src="<?php echo e(asset('assets/img/icon3.svg')); ?>" alt="">
                            <a href="tel:+442035140043">+442035140043</a>
                        </div>
                    </div>

                    <div class="reach-item">
                        <img loading="lazy" class="reach-img" src="<?php echo e(asset('assets/img/map2.png')); ?>" alt="">
                    ...
                    <div class="reach-item">
                        <img loading="lazy" class="reach-img" src="<?php echo e(asset('assets/img/map3.png')); ?>" alt="">
                ...
                <div class="reach">
                    <div class="reach-item">
                        <img loading="lazy" class="reach-img" src="<?php echo e(asset('assets/img/map4.png')); ?>" alt="">
                    ...
                    <div class="reach-item">
                        <img loading="lazy" class="reach-img" src="<?php echo e(asset('assets/img/map5.png')); ?>" alt="">
                        ...
                        <div class="reach-text">
                            <img loading="lazy" src="<?php echo e(asset('assets/img/icon4.svg')); ?>" alt="">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\datatile\resources\views/about.blade.php ENDPATH**/ ?>