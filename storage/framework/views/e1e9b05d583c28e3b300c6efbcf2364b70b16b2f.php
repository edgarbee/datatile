...
<div class="row-posts">
    ...
    ?>
    <?php $__currentLoopData = \Illuminate\Support\Facades\DB::table('binshops_post_categories')->where('category_id', $thisPost->category_id)->where('post_id', '!=',$thisPost->post_id)->inRandomOrder()->limit(3)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedPost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php
...
</div><?php /**PATH C:\OpenServer\domains\datatile\resources\views/vendor/binshopsblog/partials/related.blade.php ENDPATH**/ ?>