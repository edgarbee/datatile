...
return [
    ...
    'captcha' => [
        ...
        'basic_question' => "2+2", // a simple captcha question to always ask (if captcha_type is set to 'basic'
        'basic_answers' => "4", // comma separated list of possible answers. Don't worry about case.
    ],
